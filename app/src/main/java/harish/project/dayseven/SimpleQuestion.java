...
public class SimpleQuestion extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bstop_mute =  findViewById(R.id.bstop_mute);
        ...
        simple_question = getResources().getStringArray(R.array.difficult_ques);
        simple_question = getResources().getStringArray(R.array.difficult_ans);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bshowanswer:
                ...
                tvanswer.setText(simple_question[index]);
            ...
            case R.id.bright:
                ...
                if (index == simple_answers.length) {
            ...
            case R.id.bspeak:
                ...
                if (result == TextToSpeech.LANG_NOT_SUPPORTED
                    ...
                    if(tvanswer.getText().toString().equals(default_answer)){
                        ...
                        ttsobject.speak(simple_question[index],
